...
const ot = [
  ...
  Gn = {
    56: {
      HAI: "0x0409633A72D846fc5BBe2f98D88564D35987904D",
      LP_AXI_BNB: "0xdff88a0a43271344b760b58a35076bf05524195c",
      AXI_LEGACY: "0xdff88a0a43271344b760b58a35076bf05524195c",
      PHX: "0x2A44baB23e3869044083deEF23c9ad0Abd88518F",
    },
    97: {
      HAI: "0xB19586D1C0322Fc48bB784f5aF4A862c21dd03f3",
      LP_AXI_BNB: "0xf09f5e21f86692c614d2d7b47e3b9729dc1c436f",
      AXI_LEGACY: "0xf09f5e21f86692c614d2d7b47e3b9729dc1c436f",
      PHX: "0x778aff493ec182e948f462fa45396dfa7d9af7c3",
    },
  },
  qn = {
    56: {
      AXI_V1: "0x0b29cc2a4bbc9cb75519cdcd3995de9e7a914fb1",
      AXI_V2: "0xadA58Cf32276CCD03a1C155688eFF8B3BC282285",
      LP_AXI_BNB: "0xadA58Cf32276CCD03a1C155688eFF8B3BC282285",
    },
    97: {
      AXI_V1: "0x65479eB445368F79FE8b73E0CC375C0042f8F748",
      AXI_V2: "0x65479eB445368F79FE8b73E0CC375C0042f8F748",
      LP_AXI_BNB: "0x65479eB445368F79FE8b73E0CC375C0042f8F748",
    },
  },
  it = parseInt("56"),
...
const da = P(ee)(({ theme: { palette: t } }) => ({
  ...
  "&.MuiButton-contained": {
    background: "linear-gradient(80.54deg, #00ff9d 0%, #00aa40 100%)",
    "&:hover": {
      background:
        "linear-gradient(0deg, rgba(255, 255, 255, 0.25), rgba(255, 255, 255, 0.25)), linear-gradient(80.54deg, #00ff9d 0%, #00aa40 100%)",
    },
    "&.Mui-disabled": {
      background:
...
var ya = "/img/logo image.png",
  fa = "/img/logo image.png";
const ba = [
        ...
        Xe,
        {
          ...
          sx: {
            ...
            "::before": {
              ...
              width: "2px",
              height: "100%",
              background: "linear-gradient(to right, #00ff9d 0%, #00aa40 100%)",
  ...
  const { connected: n } = I(),
    ...
    b = i.exports.useMemo(() => {
      const f = [
        ...
        { label: "Total Staked", value: `${T(l)} HAI` },
      ];
      return (
        n &&
          f.push({
    ...
    outputs: [
      {
        ...
        internalType: "struct AXIStaking.RateLevel",
        name: "",
        type: "tuple",
      },
    ],
      ...
      if (u) {
        try {
          ...
          console.log("Harvest:", g),
            r(`Successfully harvested ${T(c)} HAI`, { variant: "success" }),
            y();
        } catch (d) {
  ...
  const [s, a] = i.exports.useState(!1),
    ...
    v = i.exports.useCallback(async () => {
      ...
      console.log("Unstake:", E),
        c(`Successfully unstaked ${T(p)} HAI`, { variant: "success" }),
        u(),
        g();
    }, [b, p, c, u, g]),
    B = i.exports.useCallback(async () => {
  ...
  za = {
    AXI_V2: {
      ...
      Unstake: e.createElement(
        e.Fragment,
        null,
        "Unstaking is subject to a 7-day hold. Once the hold has been completed, you may withdraw your HAI back to your wallet.",
        e.createElement("br", null),
        e.createElement("br", null),
    ...
    AXI_V1: {
      ...
      Unstake: e.createElement(
        e.Fragment,
        null,
        "The unstaking hold period has been removed for this pool. You may immediately withdraw your HAI to your wallet below after unstaking first.",
        e.createElement("br", null),
        e.createElement("br", null),
        "Note: Unstaking will automatically harvest your rewards."
      ),
...
function _a({ pool: t, token: n, logo: s, disabledActions: a }) {
  ...
  const [r, o] = i.exports.useState(!1),
    ...
    De = i.exports.useCallback(async () => {
      ...
      console.log("Stake:", J),
        p(`Successfully staked ${T(h)} HAI`, { variant: "success" }),
        g(),
        se();
    }, [z, A, v, p, g, se]),
    Oe = i.exports.useCallback(async () => {
      ...
      console.log("Apply:", H),
        p(`Successfully applied withdrawal of ${T(A)} HAI`, {
          variant: "success",
        }),
        g(),
        se();
...
var At = [
  {
    inputs: [
      { internalType: "address", name: "oldAXI", type: "address" },
  ...
  return e.createElement(
    ...
    e.createElement(
      ...
      e.createElement(
        ...
        e.createElement(Mt, null, "Stake $HAI"),
        e.createElement(Qa, { pool: "AXI_V2" })
      ),
      e.createElement(
        x,
        { variant: "subtitle2", mb: 3, lineHeight: "24px" },
        "Stake the new HAI V2 token to earn HAI. ",
        e.createElement("br", null),
    ...
    e.createElement(
      ...
      e.createElement(
        x,
        { variant: "subtitle2", mb: 3, lineHeight: "24px" },
        "This pool is no longer active. You must unstake and migrate your tokens to the new HAI V2 token. Migrate your tokens",
        " ",
        e.createElement(
          Ye,
...
const as = [
  {
    token: "AXI_LEGACY",
    tokenName: "HAI V1",
    swapMethodName: "convertAXI",
    tokenTitle: "HAI",
    description: e.createElement(
      e.Fragment,
      null,
      "Swap ERC-20 HAI V1 tokens for HAI V2 tokens ",
      e.createElement("br", null),
      " at a 100:1 rate."
    ),
    moreLink:
      "https://phoenixglobal.medium.com/HAI-token-redenomination-1b321687daa",
  },
  {
    token: "ETH",
    tokenName: "ETH",
    swapMethodName: "convertETH",
    tokenTitle: "ETH",
    description: e.createElement(
      e.Fragment,
      null,
      "Swap ETH tokens for HAI V2 tokens ",
      e.createElement("br", null),
      " at a 100:1 rate."
    ),
    moreLink:
      "https://phoenixglobal.medium.com/HAI-token-redenomination-1b321687daa#be16",
  },
];
function ss() {
  return e.createElement(
